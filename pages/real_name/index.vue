<template>
	<view>
		...
		<!--状态图标-->
		<view class="app-status-image-view">
			<image src="/static/app/img/non_real_name.png" mode="widthFix" v-if="!status" @tap="statusTap"/>
			<image src="/static/app/img/real_name.png" mode="widthFix" v-if="status" @tap="statusTap"/>
		</view>
		...
		<!--文字说明-->
		<view class="text-gray text-center app-content-view" v-if="!status">
		...
		<!--按钮-->
		<view class="app-btn-view" v-if="!status">
