<template>
	<view>
		...
		<view class="bg-white app-goods-details-box">
			...
			<view class="text-gray text-sm text-cut app-goods-tip-view">您购买的商品信息仅对您本人可见,不会对他人展示。</view>
		</view>
		
		<!--间距-->
		<view class="app-hight-view"/>
		
		<!--评价内容-->
		<view class="app-appraise-view">
