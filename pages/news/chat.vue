<template>
	<view>
		...
		<!--商品信息-->
		<view class="bg-white app-goods-details-box pay_status">
			...
			<!--提示-->
			<view class="app-goods-tip-view" :class="tipShow?'show':''">
			...
			<!--按钮-->
			<view class="app-goods-info-btn-view" @tap="tipShowTap">
		...
		<!--聊天框-->
		<view class="app-chat-scroll-view" :class="chatShow?'tools':''" @tap="setToolsHidden">
		...
		<view class="bg-white app-footer-fixed app-foot-padding-bottom">
			<!--操作区域-->
			<view class="cu-bar input app-foot-bar-input-tools">
				<view class="action">
			...
			<!--快捷输入-->
			<view class="app-speedy-view" :class="speedyShow?'show':''">
			...
			<!--表情栏-->
			<view class="app-emoji-view" :class="emojiShow?'show':''">
					...
					<swiper class="emoji-swiper" :current="emoji_swiper" indicator-dots @change="emoji_change">
						<swiper-item>
							<view class="cu-list grid no-border">
								...
								<image class="del_btn" src="/static/app/img/aa2.png" mode="widthFix" @tap="emojiDelTap"/>
							</view>
						</swiper-item>
						<swiper-item>
							<view class="cu-list grid no-border">
				...
				<scroll-view class="emoji-tools-scroll-view" scroll-x>
					<view id="emojiutilss1" class="emoji-tools-item" :class="emojiUrl=='emoji'?'select':''" @tap="emojiutilss_tap('emoji')">
						<image class="emoji" src="/static/images/emoji/1.png" mode="widthFix"/>
					</view>
					<view id="emojiutilss2" class="emoji-tools-item" :class="emojiUrl=='emoji_1'?'select':''" @tap="emojiutilss_tap('emoji_1')">
						<image class="emoji" src="/static/images/emoji_1/1.png" mode="widthFix"/>
					</view>
				</scroll-view>
			</view>
			...
			<!--更多工具-->
			<view class="app-tools-view" :class="toolsShow?'show':''">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/chat.scss";
</style>
