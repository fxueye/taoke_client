<template>
	<view>
		...
		<!--文章标题-->
		<view class="text-black text-bold text-lg app-title">提升幸福感的居家好物</view>
		<view class="text-gray text-sm text-right margin-lr app-right-text">
			<text>浏览38439</text>
			<text>关注38439</text>
		</view>
