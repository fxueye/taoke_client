<template>
	<view>
		...
		<!--轮播图-->
		<view class="app-banner-swiper-box">
			...
			<!--页码-->
			<text class="cu-tag bg-grey round sm app-page">{{bannerCur + 1}} / {{bannerList.length}}</text>
		</view>
		
		<!--限时秒杀-->
		<view class="app-limited-seckill-box">
			<text class="text-price text-xxl">2999</text>
			<view class="text-xs app-cost-price-num price-4">
				<view class="text-through">原价￥6999</view>
				<view>剩余79件</view>
			</view>
			<view class="text-right app-time-right">
				<view>自营限时秒杀</view>
		...
		<!--标题-->
		<view class="bg-white app-view-box app-title-view-box">
			<view class="title-view">
				<text class="cu-tag bg-red radius sm">自营</text>
				<text class="text-black text-lg text-bold">99新苹果iPhoneX 64G深空灰色国行</text>
			</view>
			<view class="light bg-red radius margin-top-sm app-title-tip-box">
				<view class="text-cut">
		...
		<!--服务-->
		<view class="margin-top bg-white app-view-box app-service-view-box" @tap="serviceTap">
		...
		<!--促销-->
		<view class="margin-top bg-white app-view-box app-promotion-view-box">
		...
		<!--选择-->
		<view class="margin-top bg-white app-view-box app-select-view-box">
			<view class="flex flex-wrap text-sm">
				<view class="basis-1">
		...
		<!--评论-->
		<view class="margin-top bg-white app-comment-view-box">
		...
		<!--杂项信息-->
		<view class="margin-top bg-white app-view-box app-goods-info-view-box">
			<view class="app-shop-view">
			...
			<view class="app-border-view"/>
			<view class="app-recommend-list-box">
		...
		<!--图片详情-->
		<view class="margin-top app-goods-details-box">
			<image src="/static/images/home/goods/goods-1.png" mode="widthFix"/>
			<image src="/static/images/home/goods/goods-2.png" mode="widthFix"/>
		</view>
		
		<!--常见问题-->
		<view class="margin-top bg-white margin-bottom app-view-box app-goods-help-view-box">
		...
		<!--相似推荐-->
		<view class="margin-top app-view-box app-recommend-list-view-box">
			...
			<view class="margin-bottom app-goods-list-box">
		...
		<!--弹出框-->
		<view class="cu-modal bottom-modal app-bottom-modal-box" :class="bottomModal?'show':''">
			<view class="cu-dialog bg-white">
				<!--标题-->
				<view class="text-black text-center margin-tb text-lg app-title-bar">
				...
				<view class="app-modal-content">
					...
					<!--服务区域-->
					<view class="app-view-box service" v-if="modalType=='service'">
						<view class="text-view">
							<text class="cuIcon-title text-red"/>
					...
					<!--促销区域-->
					<view class="app-view-box promotion" v-if="modalType=='promotion'">
						<view class="text-view">
					...
					<!--选择规格-->
					<view class="app-view-box select" v-if="modalType=='select'">
						<!--商品信息-->
						...
						<!--规格数据-->
						<view class="app-select-btn-list-boox">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/goods.scss";
</style>
