<template>
	<view>
		...
		<!--商品信息-->
		<view class="bg-white app-goods-details-box">
		...
		<!--支付方式-->
		<view class="bg-white app-pay-view">
			<radio-group class="block" @change="RadioChange">
				<view class="app-pay-bar" @tap="payTap('wechat')">
					<view class="cu-avatar sm" style="background-image:url(/static/app/img/wechat.png)"/>
					<view class="content">
					...
					<view class="action">
						<radio class="red app-radio" :class="radio=='wechat'?'checked':''" :checked="radio=='wechat'?true:false" value="wechat"/>
					</view>
				</view>
				
				<view class="app-pay-bar" @tap="payTap('alipay')">
					<view class="cu-avatar sm" style="background-image:url(/static/app/img/alipay.png)"/>
					<view class="content">
						<view class="text-black">
					...
					<view class="action">
						<radio class="red app-radio" :class="radio=='alipay'?'checked':''" :checked="radio=='alipay'?true:false" value="alipay"/>
					</view>
				</view>
			</radio-group>
		</view>
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/pay.scss";
</style>
