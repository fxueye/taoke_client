<template>
	<view>
		...
		<!--收货地址-->
		<view class="margin-tb-sm app-view-box">
			<view class="bg-white app-card address-view">
		...
		<!--商品信息-->
		<view class="margin-tb-sm app-view-box">
			<view class="bg-white app-card goods-view">
				...
				<view class="text-black app-gift-list">
				...
				<view class="margin-top-lg checked-view">
					<checkbox class='round red sm app-checked checked'/>
				...
				<view class="margin-top-sm flex app-service-view">
					...
					<view class="flex-sub bg-page padding-sm margin-xs radius">
						...
						<view class="app-corner-mark check"/>
		...
		<!--支付方式-->
		<view class="margin-tb-sm app-view-box">
			<view class="bg-white app-card pay-view">
		...
		<!--商品价格计算-->
		<view class="margin-tb-sm app-view-box">
			<view class="bg-white app-card app-price-view">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/settlement.scss";
</style>
