<template>
	<view>
		...
		<view class="bg-white app-cart-list-view">
			<checkbox-group class="block" @change="CheckboxChange">
				<block v-for="(item,index) in goodsList" :key="item.id">
					<view class="padding app-checkbox-title-view">
						<checkbox class='round red sm app-checked' :class="item.checked?'checked':''"
					...
					<block v-for="(items,indexs) in item.goods" :key="items.id">
						<view class="light goods-list-item-view">
							<checkbox class='round red sm app-checked' :class="items.checked?'checked':''" 
							...
							<view class="goods-info-view">
								...
								<view class="goods-price-view">
									...
									<view class="step-btn-view">
										<button class="app-btn text-gray">-</button>
										<input class="app-input" type='number' :value="items.num"></input>
		...
		<view class="bg-white app-footer-fixed app-foot-padding-bottom">
			<view class="cu-bar padding-lr">
				<view class="checked-view" @tap="tapChecked"> 
					<checkbox class='round red sm app-checked' :class="checkAll?'checked':''" :checked="checkAll"></checkbox>
		...
		<!-- #ifdef MP -->
			<!--编辑-->
			<view class="app-add-btn-view-box" @tap="barEditTap">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/my_cart.scss";
</style>
