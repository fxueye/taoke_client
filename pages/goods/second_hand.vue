<template>
	<view>
		...
		<view class="bg-white app-scroll-tab-view" v-if="!barShow">
		...
		<!--Tab栏占位-->
		<view class="app-scroll-height-view" v-if="!barShow"/>
		
		<!--商品简介-->
		<view class="bg-white padding app-goods-synopsis-view">
			...
			<view class="text-sm margin-top-sm app-map-view">
		...
		<!--服务-->
		<view class="margin-top padding bg-white app-service-view-box">
		...
		<!--商品详情-->
		<view class="margin-top padding bg-white app-details-view-box">
			...
			<view class="text-black app-text-content-view">iphoneX,美版256G,原装正品，无拆修，配件齐全，功能正常使用</view>
			
			<view class="app-img-box">
			...
			<view class="bg-white app-steps-view">
		...
		<!--关于卖家-->
		<view class="margin-top bg-white app-selll-user-view-box">
			...
			<view class="padding app-grid-tab-view">
			...
			<!-- #ifndef MP-TOUTIAO -->
			<view class="app-goods-swiper-view">
		...
		<!--互动-->
		<view class="margin-top padding bg-white app-interaction-view-box">
			...
			<view class="app-interaction-view" v-else>
				...
				<view class="app-interaction-list-view">
			...
			<view class="app-tag-text-view-box">
				<view class="text-cut">
		...
		<!--您推荐同型号已验机商品-->
		<view class="margin-top padding bg-white app-recommend-goods-box">
			<view class="text-black">为您推荐同型号已验机商品</view>
			<view class="margin-top app-goods-info-box">
		...
		<!--底部操作-->
		<view class="bg-white app-footer-fixed app-foot-padding-bottom">
			<view class="cu-bar">
				<view class="flex flex-wrap">
					<view class="basis-xs">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/second_hand.scss";
</style>
