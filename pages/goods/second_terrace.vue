<template>
	<view>
		...
		<view class="margin-top padding bg-white app-details-view-box">
			...
			<view class="bg-gray padding radius app-bubble-view">
		...
		<view class="margin-top padding bg-white app-interaction-view-box">
			...
			<view class="text-center app-interaction-view">
...
<style lang="scss">
	...
	/* #endif */
	@import "../../static/app/style/second_terrace.scss";
</style>
