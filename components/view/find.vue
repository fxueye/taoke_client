<template>
	<view class="app-find-box" :class="show?'show':''">
		<!--分类标题栏-->
		<view class="bg-white app-title-tab-box">
			
			<!--小程序端的标题-->
			<!-- #ifdef MP -->
			<view class="text-center text-black app-small-routine-title">发现</view>
			<!-- #endif -->
...
<script>
	...
	//======================================================================
	import _find_data from '@/static/data/find.js';	//虚拟数据
