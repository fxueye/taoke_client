<template>
	<view class="app-news-box" :class="show?'show':''">
		<!--标题栏-->
		...
		<!--关注-->
		<view class="cu-bar bg-white app-follow-box">
		...
		<!--宫格菜单-->
		<view class="margin-bottom app-grid-menu">
		...
		<!--消息列表-->
		<view class="bg-white app-news-list-box">
