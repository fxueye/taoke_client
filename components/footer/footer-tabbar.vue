<template>
	<view class="cu-bar tabbar bg-white app-footer-fixed">
		<view class="cu-bar tabbar bg-white app-footer-fixed">
			...
			<view class="action" :class="TabID == 1?'text-red':'text-black'" @tap="tabTap(1)">
				<view :class="TabID == 1?'cuIcon-likefill':'cuIcon-like'"></view>
				<text>9.9包邮</text>
			</view>
			<view class="action add-action" @tap="tabTap(2)">
				<button class="cu-btn cuIcon-goods bg-red shadow"></button>
				<text>发现</text>
			</view>
