<template>
	<view class="bg-white margin-top radius app-hot-topic-box">
		<!--标题-->
		...
		<view class="hot-topic-scroll-box">
			...
			<!--右边阴影-->
			<view class="app-right-shadow-box"></view>
		</view>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			getScrollPageNum(data) {
				this.list_num =  utils.getPageNum(data.length,3);
			},
